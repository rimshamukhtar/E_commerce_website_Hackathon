...
//         <p>Download the app to access everything Nike. <span className='font-bold hover:'>Get Your Great</span>
//         </p>
//         </div>
//         <div className='b'>
//             <Image src="/Heroimage.png" alt='' width={1200} height={700} />
//         </div>
...
//             <p className='w-[550px]'>Extreme comfort. Hyper durable. Max volume. Introducing the Air Max Pulse
//             —designed to push you past your limits and help you go to the max.</p>
//             <div className='flex justify-center gap-3'>
//     <button className='rounded-full  w-28 h-9 bg-black text-white '>Notify Me</button>
//     <button className='rounded-full  w-32 h-9 bg-black text-white  '>Shop Air Max</button>
//     </div>
//         </div>
//       </div>
